---
title: Jesse Pinzon
subtitle: Senior AI Engineer · Product & AI Systems
pdf-engine: xelatex
...
- Standardized MLOps/LLMOps, CI/CD, and infrastructure as code with Azure DevOps, Terraform, MLflow, Application Insights, and Prometheus; shortened release lead time from **15 business days to 5**.
...
- Built and evolved model training, validation, registry, and deployment pipelines with Airflow, SageMaker, S3, Docker, Jenkins, and MLflow; cut the validation-to-production cycle from **six weeks to two**.
